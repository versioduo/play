...
class V2PlayerDisplay extends V2WebModule {
  ...
  showVersion() {
    this.#timeSignature.innerHTML = '<a href="https://github.com/versioduo/play" target="software">play</a>, version ' + Number(document.querySelector('meta[name="version"]').content);
    super.show();
  }
